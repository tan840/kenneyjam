...
Shader "Toony Colors Pro 2/User/CustomHGradOutline"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
	...
	SubShader
	{
		...
		struct v2f_outline
		{
			...
			float3 pack3 : TEXCOORD4; /* pack3.xyz = objPos */
		...
		float4 fragment_outline (v2f_outline input) : SV_Target
		{
			...
			half vertFogThreshold = input.pack3.xyz.y;
