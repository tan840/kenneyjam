...
Shader "Toony Colors Pro 2/User/CarCrumple"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
	...
	SubShader
	{
		...
		void surf(Input input, inout SurfaceOutputCustom output)
		{
			...
			float4 __normalMap = ( tex2D_triplanar(_BumpMap, float4(1, 1, 1, 1) * _BumpMap_ST, input.worldPos, input.worldNormal) );
