...
Shader "Toony Colors Pro 2/User/CustomHGrad Sill"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
	...
	SubShader
	{
		...
		Pass
		{
			...
			struct v2f_sil
			{
				...
				float3 pack2 : TEXCOORD2; /* pack2.xyz = objPos */
			};
