...
Shader "Toony Colors Pro 2/User/CustomHGradGlobalVert"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
		_Color ("Color", Color) = (1,1,1,1)
		 _MainColor ("BlueMask", Color) = (1,1,1,1)
	...
	SubShader
	{
		...
		void surf(Input input, inout SurfaceOutputCustom output)
		{
			...
			float4 __mainColor = (  lerp(_Color.rgba, _MainColor.rgba, input.vertexColor.r) );
...
/* TCP_DATA u config(unity:"2020.3.7f1";ver:"2.8.1";tmplt:"SG2_Template_Default";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","UNITY_2019_4","UNITY_2020_1","WRAPPED_LIGHTING_CUSTOM","SHADOW_HSV","SPEC_LEGACY","SPECULAR","SPECULAR_TOON","SPECULAR_NO_ATTEN","SPECULAR_SHADER_FEATURE","EMISSION","RIM","RIM_DIR","RIM_LIGHTMASK","RIM_SHADER_FEATURE","SUBSURFACE_SCATTERING","SS_SHADER_FEATURE","SUBSURFACE_AMB_COLOR","CUBE_AMBIENT","AMBIENT_SHADER_FEATURE","VERTICAL_FOG","VERTICAL_FOG_ALPHA","ENABLE_FOG","ENABLE_LIGHTMAPS","VERTICAL_FOG_SHADER_FEATURE"];flags:list[];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",RIM_LABEL="Rim Lighting"];shaderProperties:list[,sp(name:"Main Color";imps:list[imp_customcode(prepend_type:Disabled;prepend_code:"";prepend_file:"";prepend_file_block:"";preprend_params:dict[];code:"lerp({2}.rgba, {3}.rgba, {4}.r)";guid:"ca4eb1a8-42cd-4ae3-891d-10511f3a4514";op:Multiply;lbl:"Main Color";gpu_inst:False;locked:False;impl_index:-1),imp_mp_color(def:RGBA(1, 1, 1, 1);hdr:False;cc:4;chan:"RGBA";prop:"_Color";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"c97dd245-a546-40dd-b47a-449f622f1c90";op:Multiply;lbl:"Color";gpu_inst:False;locked:False;impl_index:0),imp_mp_color(def:RGBA(1, 1, 1, 1);hdr:False;cc:4;chan:"RGBA";prop:"_MainColor";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"05e4ae57-4844-4078-9e78-c3eb0aa5d6c0";op:Add;lbl:"BlueMask";gpu_inst:False;locked:False;impl_index:-1),imp_vcolors(cc:4;chan:"RGBA";guid:"f1628982-df5e-4be7-a6ef-92f73cb04ded";op:Multiply;lbl:"Main Color";gpu_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];clones:dict[];isClone:False)];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH a5f5768773566d2489bc1ab535665712 */
